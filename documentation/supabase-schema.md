...
| formularios               | marca_id                      | uuid                     | YES         | FOREIGN KEY     | marca_id                 | marcas                  | id                |
| formularios               | plataforma_id                 | uuid                     | YES         | FOREIGN KEY     | plataforma_id            | plataformas             | id                |
...
| landing_pages             | modelo_ids                    | ARRAY                    | YES         | null            | null                     | null                    | null              |
| landing_pages             | nome                          | text                     | YES         | null            | null                     | null                    | null              |
| landing_pages             | descricao                     | text                     | YES         | null            | null                     | null                    | null              |
...
| leads                     | marca_id                      | uuid                     | YES         | FOREIGN KEY     | marca_id                 | marcas                  | id                |
...
| modelos                   | foto_destaque                 | text                     | YES         | null            | null                     | null                    | null              |
| modelos                   | galeria                       | ARRAY                    | YES         | null            | null                     | null                    | null              |
